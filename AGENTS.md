...
Indexes: `_project/{TODO|DONE}/_indexes/`. Template: `TODO_ENTRY_TEMPLATE.yaml`. Schema: `TODO_SCHEMA.yaml`.
...
After changes: `uv run _project/scripts/generate_indexes.py`. See `~/.claude/skills/todo/SKILL.md`.
