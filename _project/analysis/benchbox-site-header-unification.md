...
|---|---|---|---|---|---|---|---|
| Landing | `landing/index.html`, `landing/style.css`, `landing/script.js` | Home, Docs, Blog, Results, GitHub, plus in-page section anchors | None | 1200px, padded fixed bar | Fixed | JS-created hamburger, hides section anchors | None |
| Docs/blog | `docs/_templates/page.html`, `docs/_static/custom.css` | Home, Docs, Blog, Results, GitHub | None | 1200px, 0.75rem vertical padding | Sticky | Hides all links | None |
...
| Global link order | Home, Docs, Blog, Results, GitHub, Run benchmark |
| URLs | `https://benchbox.dev/`, `/docs/`, `/blog/`, `/results/`, `https://github.com/joeharris76/BenchBox`, and `https://benchbox.dev/docs/usage/installation.html`. `/prompts/` is reached from the landing page's AI Assistant Integration section, not the global header. |
...
- Make Results the canonical header: rejected because it was missing the Home link and used a different max width.
