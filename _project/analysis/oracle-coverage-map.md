...
content-revision: sha256:a9b0a06828bb84ac
...
**Summary:** 23 shipped benchmarks — 12 guarded (oracle registered), 11 UNGUARDED (9 reachable by the cross-surface gate, 2 single-surface needing a fallback oracle). Cross-surface gates: 9 CI-enforced, 0 staged (not CI-enforced).
