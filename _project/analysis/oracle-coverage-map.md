...
content-revision: sha256:878d4904ca00a37d
...
**Summary:** 23 shipped benchmarks — 12 guarded (oracle registered), 11 UNGUARDED (9 reachable by the cross-surface gate, 2 single-surface needing a fallback oracle). Cross-surface gates: 8 CI-enforced, 1 staged (not CI-enforced).
