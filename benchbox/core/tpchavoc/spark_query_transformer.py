...
The Spark adapter keeps its lazy compatibility import at
``benchbox.platforms.spark_query_transformer``; the implementation lives here
so core query generation can reuse it without importing an adapter layer.
