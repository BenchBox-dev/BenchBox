...
| vector_search | SF 0.01 (DuckDB tuned-fallback, applied_unverified) | SF 0.1, SF 1.0 — deferred, no tuned path run yet |
| joinorder_synthetic | SF 1.0 bundle present (DuckDB tuned-fallback, applied_unverified; internal surface, excluded from public inventory by design) | inventory listing — internal surface never lists |
