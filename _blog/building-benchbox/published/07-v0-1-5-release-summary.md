...
We wrote about the extraction process in detail in [post #6](06-extracting-textcharts.md). This section covers what shipped and what it means for BenchBox users.
...
- Post #6: ["Extracting textcharts from BenchBox exposed hidden coupling"](06-extracting-textcharts.md)
