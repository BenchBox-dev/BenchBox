...
For query execution, `PRAGMA tpch(query_id)` provides direct query access with predefined bind behavior ([DuckDB TPC-H extension docs](https://duckdb.org/docs/stable/core_extensions/tpch.html), [DuckDB benchmarking guide](https://duckdb.org/docs/stable/guides/performance/benchmarking.html)).
...
2. [DuckDB benchmarking guide](https://duckdb.org/docs/stable/guides/performance/benchmarking.html)
...
*Status: Published | Published to: docs/blog/2026-03-03-duckdb-tpch-extension-vs-benchbox.md | Updated: 2026-03-02*
