...
meta_description: "BenchBox v0.3.0 moves JoinOrder to real IMDb JOB data, adds 113 queries, expands sketch coverage, and adds a prompt builder for safer local first runs."
status: draft
---
