...
- Publication: GitHub release published August 28, 2026; changelog and tag dated August 27.
...
- Explorer figures: deployed `results.duckdb` snapshot checked August 28, 2026.
...
- Explain source, trust, and funding labels without implying differentiated current coverage.
...
- Bundled TPC tools are probed and compiled from source if incompatible. Do not claim the shipped
  macOS binaries themselves were repaired.
...
- Do not invite result submissions while the public contribution instructions remain closed and
  inconsistent.
