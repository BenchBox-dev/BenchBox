...
class TestPrestoAdapter:
    ...
    def test_optimize_table_definition_strips_primary_key_for_memory(self, presto_stubs):
        """Presto rejects inline PRIMARY KEY syntax in benchmark DDL."""
        adapter = PrestoAdapter(table_format="memory")
    ...
    def test_optimize_table_definition_strips_primary_key_for_hive(self, presto_stubs):
        """Hive-backed Presto DDL also needs PRIMARY KEY metadata removed."""
        adapter = PrestoAdapter(table_format="hive")
    ...
    def test_joinorder_schema_is_presto_compatible_after_optimization(self, presto_stubs):
        """Canonical JoinOrder DDL should not send PRIMARY KEY to Presto."""
        adapter = PrestoAdapter(table_format="memory")
