...
class TestDataFusionIntegration:
    ...
    def test_query_execution_with_filter(
        ...
        # The pipe-delimited fixture in a .csv file loads as a single string
        # column, so compare against a string literal: since datafusion 54,
        # mixed string/int comparisons are a cast error instead of coercing.
        result = datafusion_adapter.execute_query(
            datafusion_connection,
