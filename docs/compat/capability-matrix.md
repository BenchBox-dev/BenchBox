...
| phase | scope | action | support | failure mode | rule_id |
|---|---|---|---|---|---|
| query_source | benchmark=tpcdi, query=EQ7 | select_variant | REWRITTEN | UNSUPPORTED_FEATURE | `query_source.snowflake.tpcdi.eq7_derived_table_variant` |
...
| query_adapter | benchmark=tpchavoc, query=10_v1 | rewrite_query | REWRITTEN | UNSUPPORTED_FEATURE | `query_adapter.spark.tpchavoc.q10_scalar_group_by_first` |
| query_adapter | benchmark=tpchavoc, query=12_v1 | rewrite_query | REWRITTEN | UNSUPPORTED_FEATURE | `query_adapter.spark.tpchavoc.q12_scalar_group_by_first` |
| query_adapter | benchmark=tpchavoc, query=14_v2 | rewrite_query | REWRITTEN | UNSUPPORTED_FEATURE | `query_adapter.spark.tpchavoc.q14_group_by_empty_drop` |
| query_adapter | benchmark=tpchavoc, query=16_v1 | rewrite_query | REWRITTEN | UNSUPPORTED_FEATURE | `query_adapter.spark.tpchavoc.q16_scalar_group_by_first` |
| query_adapter | benchmark=tpchavoc, query=17_v4 | rewrite_query | REWRITTEN | UNSUPPORTED_FEATURE | `query_adapter.spark.tpchavoc.q17_dual_column_alias` |
| query_adapter | benchmark=tpchavoc, query=1_v1 | rewrite_query | REWRITTEN | UNSUPPORTED_FEATURE | `query_adapter.spark.tpchavoc.q01_scalar_group_by_first` |
| query_adapter | benchmark=tpchavoc, query=3_v1 | rewrite_query | REWRITTEN | UNSUPPORTED_FEATURE | `query_adapter.spark.tpchavoc.q03_scalar_group_by_first` |
| query_adapter | benchmark=tpchavoc, query=6_v2 | rewrite_query | REWRITTEN | UNSUPPORTED_FEATURE | `query_adapter.spark.tpchavoc.q06_group_by_empty_drop` |
| query_adapter | benchmark=tpchavoc, query=7_v1 | rewrite_query | REWRITTEN | UNSUPPORTED_FEATURE | `query_adapter.spark.tpchavoc.q07_scalar_group_by_first` |
| query_adapter | benchmark=tpchavoc, query=8_v1 | rewrite_query | REWRITTEN | UNSUPPORTED_FEATURE | `query_adapter.spark.tpchavoc.q08_scalar_group_by_first` |
| query_adapter | benchmark=tpchavoc, query=9_v1 | rewrite_query | REWRITTEN | UNSUPPORTED_FEATURE | `query_adapter.spark.tpchavoc.q09_scalar_group_by_first` |
