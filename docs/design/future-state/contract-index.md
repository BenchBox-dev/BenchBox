...
| Define benchmark family plugin seam before core package extraction | Piloted on SSB | benchmark-api | Keep public wrapper tests green, lock registry/wrapper/loader counts, and keep later families off the seam until a second measurement exists. | `docs/design/future-state/benchmark-family-plugin-seam/README.md`, `docs/reference/public-contracts.md`, `benchbox/core/benchmark_loader.py`, `benchbox/core/ssb/family.py` |
